...
completed_title = tk.Label(complete_page, text="Completed", font=("times new roman", 69, "bold"))
# need to place
completed_sub_title = tk.Label(complete_page, text="{user}'s To-Do-List}", font=("times new roman", 69, "bold"))
# need to place


back_button = tk.Button(complete_page, text="Back", relief="sunken" ,font=("times new roman", 30))
